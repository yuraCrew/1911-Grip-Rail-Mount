...
Random Info:
I don't use any nuts because it complicates the design, all screws are threaded directly into the polymer because it works and it's easy. Apparantly there are "self tapping" m3 screws that exist but a regular m3 screw will work just fine and is what I use. It can be a bit tricky to get the screw started so what you can put an m3x20 in the chuck of a drill and start the thread that way.

The tolerance between the gripMountOffset and mainGrip is a press fit. I use a pair of vice grips to press them together but you can also use a hammer.


External Fasteners Required:

    2 M3x6 - Attach gripMountOffset to the mainGrip
    2 M3x8 - Attach railMount to gripMountOffset
    2 M3x6 - Attach either rail to railMount

Details for printing:

    The grip was designed on a technical drawing of the RIGHT grip. If printed as is, the ejection port will be entirely blocked and your gun won't function. Therefore, you must mirror all the components (technically the picatinny and dovetail rails won't change) before printing; this is easily done in all slicers.

    I've designed the components with zero supports intented, turn off all supports and print in the common sense orientation. 
    *The main grip does NOT need supports around the bushing area.

    All parts have been tested on a Qidi X-Smart 3 and function without post processing. Tolerances have been accounted for but I've provided the step files incase you need to alter them.

    I used PLA+ for all components but I reckon anything besides tpu will work great. Theoretically, the stiffer the material the better.
